...
namespace MLModelEx
{
    public partial class TwinTalkModel
    {
        public const string RetrainFilePath =  @"C:\D\EOT\EotPlayGround\intent_dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"response",inputColumnName:@"response",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"response", sentence1ColumnName: @"question"))      
