...
namespace MLModelEx
{
    ...
    {
        /// <summary>
        /// model input class for TwinTalkModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for TwinTalkModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("TwinTalkModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("response");
            if (labelColumn == null)
            {
                throw new Exception("response column not found. Make sure the name searched for matches the name in the schema.");
            }
